...
function bundle(appPackage, config) {
    ...
    return Promise.each(values(appPackage.files), function (file) {
...
function collectBundle(loader, bundler, config, bundle) {
    ...
    entries(loader.packages, function (loaderPackage, location) {
    ...
    entries(loader.packages, function (loaderPackage, location) {
        var bundlerPackage = bundler.getPackage(location);
        entries(loaderPackage.modules, function (loaderModule, id) {
