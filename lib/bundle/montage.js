...
function bundleMontageScript(bootstrapBundle, preloadFiles, element, file, config) {
    ...
    // if (applicationPackage.mainWorkerModule) {
    //     var bootstrapWorkerScript = applicationPackage.bootstrapWorkerScript || "worker-bootstrap.js",
    //         bootstrapWorkerContent = "",
    //         workerConfiguration = {
    ...
    //     bootstrapWorkerContent += "var MontageParams =" + JSON.stringify(workerConfiguration, null, 2) + ";\n";
    //     bootstrapWorkerContent += "PATH_TO_MONTAGE='" + toMontage + "'; \n";
    //     bootstrapWorkerContent += "importScripts(" + bundleFile + ")";

    //     bootstrapWorkerScript = URL.resolve(file.package.location, bootstrapWorkerScript);
    //     bootstrapWorkerFile = new File({
    //         fs: config.fs,
    //         utf8: bootstrapWorkerContent,
    //         location: bootstrapWorkerScript
    //     });


    //     bootstrapWorkerFile.write();
    // }
}
